                          ...
                          {loadingConsent ? (
                            ...
                            <>
                              <Button
                                ...
                                onClick={() =>
                                  consentRequestHandler(notif.id, true)
                                }
                              >
                                Approve
                              </Button>
                              <Button
                                ...
                                className='btn-sm'
                                onClick={() =>
                                  consentRequestHandler(notif.id, false)
                                }
                              >
                                Decline
                              </Button>
                      ...
                      <Row className='align-items-center'>
                        <Col md={10}>
                          <p className='m-0'>
                            ...
                            has{' '}
                            <strong>
                              {notif.approved ? 'approved' : 'declined'}
                            </strong>{' '}
                ...
                <tbody>
                  {doctors.map((doctor) => (
                    <tr key={doctor._id.$oid}>
                      ...
                      <td>
                        <LinkContainer
                          to={`/consultations/add/${doctor._id.$oid}`}
                        >
                          <Button variant='light' className='btn-sm'>
                            Request
                          </Button>
